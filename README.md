...
Para la configuración de Postfix, hemos modificado los archivos que encontramos en la práctica cambiando los dominios por el que tenemos correspondiente, en mi caso, destevez.fpinfo.com.es:

<img width="545" height="264" alt="image" src="https://github.com/user-attachments/assets/88a661b7-5eec-40cd-9e7d-4f63e67f1137" />

También tenemos el DockerFile:

<img width="696" height="359" alt="image" src="https://github.com/user-attachments/assets/bb7d6651-4008-485c-b5ee-361befdbaf64" />

Y el archivo main.cf:
